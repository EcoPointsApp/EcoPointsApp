    ...
    return ListView(
      ...
      children: [
        ...
        ListTile(
          ...
          trailing: Switch(value: notifications, onChanged: onNotifications),
        ),
        ListTile(
          ...
          trailing: Switch(value: soundEnabled, onChanged: onSoundEnabled),
        ),
        ListTile(
          leading: Icon(LucideIcons.shield, color: colorScheme.primary),
          title: const Text('Privacidade dos Dados'),
          subtitle: const Text('Controle como seus dados são usados'),
        ),
        ListTile(
          ...
          trailing:
              Switch(value: locationEnabled, onChanged: onLocationEnabled),
        ),
        ListTile(
          leading: Icon(darkMode ? LucideIcons.moon : LucideIcons.sun,
              color: colorScheme.primary),
          title: const Text('Modo Escuro'),
          subtitle: const Text('Alternar tema claro/escuro'),
          trailing: Switch(value: darkMode, onChanged: onDarkMode),
        ),
        ListTile(
